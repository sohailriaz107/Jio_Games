...
<head>
    ...
    <title>Top Starline Winners - <?php echo $site_title;?></title>
    <meta name="description" content="Check out the list of todays top starline winners.">
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- Hero Section -->
            <div class="premium-hero-banner" style="background: linear-gradient(135deg, #6a11cb, #2575fc);">
                <div class="wallet-display text-center">
                    <i class="fa fa-star mb-2" style="font-size: 40px; color: #FFD700; text-shadow: 0 2px 4px rgba(0,0,0,0.2);"></i>
                    <h2 class="brand-text">Starline Champions</h2>
                    <p class="greeting">Today's Hourly Winners</p>
                </div>
            </div>
            ...
            <div class="container py-4">
                ...
                ?>
                    <div class="premium-history-card position-relative" style="margin-bottom: 25px;">
                        ...
                        <div class="history-card-body">
                            <div class="history-detail-row">
                                <div class="detail-item">
                                    ...
                                    <span style="font-weight: 700; color: #2575fc; font-size: 16px;">
                                ...
                                <div class="detail-item">
                                    ...
                                    <span><?php echo get_Starlinetime($row['game_id']); ?></span>
                                </div>
                                <div class="detail-item">
                        ...
                        <div class="history-card-status-bar" style="background: #2575fc;"></div>
                    </div>
                <?php 
                        $ranking++;
                    } 
                    ...
                    <div class="empty-state">
                        ...
                        <p>No Starline winners announced yet for today.</p>
                    </div>
                <?php } ?>
            </div>
            <br><br>
